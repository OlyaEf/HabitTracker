...
urlpatterns = [
    path('my-habits/', include(router.urls)),  # Список привычек текущего пользователя с пагинацией
    ...
    path('habits/<int:pk>/', HabitViewSet.as_view({'put': 'update', 'delete': 'destroy'}), name='habit_detail'),  # Редактирование и удаление привычки
] + router.urls
